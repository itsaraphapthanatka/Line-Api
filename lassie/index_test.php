									...
									<tr>
                                    	...
                                    	<?php 
                                        	if (!isset($_SESSION['profile'])) {
                                            	...
                                            	$link = $line->getLink();
                                    	?>
												<div class="symbol symbol-100px symbol-circle mb-2" style="text-align:center; margin:0 15px 34px 15px">
													<h1>Test</h1>
													<img class="mb-8" src="images/aof.png" alt="image" />
                                        			<a href='<?php echo $link; ?>'><img src="images/btn_login_base.png" alt="image" /></a>
												</div>
                                    	<?php } else {
											header('location: testreply.php');
										 }?>
										</td>
									</tr>
								</tbody>
