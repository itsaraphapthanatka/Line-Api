<?php
    ...
    $token = '9q2a8UtBxRQLv1JJgLbvBaVjcfelmnqsYsbgbqSX+fdPIN+u5OMYcASNzaEd8tECgjXucUv5TuZoVjN1M91c8OohjDcJwszeVo4mZV0C6qgrcWpD70aJ1CHhsiAYIHrfrZJiYDJj49Ma1seZVOagVAdB04t89/1O/w1cDnyilFU=';
    // $token = $_POST['token'];
    
    // Channel access token - (from https://developers.line.me/console/)
    $secret = '3167afe989ca0262455ca9fdc671679f';
    // $secret = $_POST['secret'];
//    $pushID = array(
