	 ...
	 $arrayPostData = [
	  ...
	  "messages" => [
		[
			...
			"hero" => [
			  "type" => "image",
			  "url" => "https://appointportal.appreview.co.th/theme/dist/assets/media/auth/11075611.jpg",
			  "size" => "full",
			  "aspectRatio" => "20:13",
			  "aspectMode" => "cover",
			  "action" => [
			...
			"body" => [
			  ...
			  [
				"type" => "text",
				"text" => "ขอขอบคุณที่ท่านได้ทำการจองนัดหมาย หากต้องการใบเสร็จการชำระค่ามัดจำ\nกรุณาแจ้งทางแชทครับ ผมจะทำการจัดส่งให้",
				"weight" => "bold",
				"size" => "md",
				"align" => "center",
				"gravity" => "center",
