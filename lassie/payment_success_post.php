<?php
 ...
 function sendLineMessage($userid,$name,$date,$time,$location,$mobile,$fullname,$packagename){
	  ...
	  curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://lineoa-appoint.lumpsum.cloud/lassie/pushmessage.php',
		...
		CURLOPT_HTTPHEADER => array(
		  'Authorization: cyhk4oo4d9/u6W3tYZlF5DDR0p3cMOe9aOJb91SbpyBB2LBQ4vqdJrE0CKoAlCHJZvdPtVSaE3PqFhoGT+m79r8JAQ2T7jNUCSqELXoUb9OPZNmQO9afNURfbhavK9lij4ue+Wfpp9mBnVgxlc0OkQdB04t89/1O/w1cDnyilFU=',
 ...
 function addCustomer($name,$email,$start,$starttime,$endtime,$fullname,$mobile,$userid,$location){
	 ...
	 $cussql = "insert into customer (customer_code,customer_name,customer_address,customer_email,customer_mobile,customer_lineid,compcode,customer_status,create_date,create_user,customer_tag,customer_line_picture,url_img) value('', '".$fullname."', '".$location."','".$email."','".$mobile."','".$userid."','lassie','active', '".$now."','".$fullname."','Line','".$actual_link."','".$url."')";
	 if ($conn->query($cussql) === TRUE) {
