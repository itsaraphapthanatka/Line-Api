...
<meta charset="utf-8">
	...
	<link href="https://lineoa-appoint.lumpsum.cloud/botpush/boostrap4/dist/assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
	<link href="https://lineoa-appoint.lumpsum.cloud/botpush/boostrap4/dist/assets/plugins/custom/prismjs/prismjs.bundle.css" rel="stylesheet" type="text/css" />
	<link href="https://lineoa-appoint.lumpsum.cloud/botpush/boostrap4/dist/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
	<!--end::Global Theme Styles-->
	<!--begin::Layout Themes(used by all pages)-->
	<link href="https://lineoa-appoint.lumpsum.cloud/botpush/boostrap4/dist/assets/css/themes/layout/header/base/light.css" rel="stylesheet" type="text/css" />
	<link href="https://lineoa-appoint.lumpsum.cloud/botpush/boostrap4/dist/assets/css/themes/layout/header/menu/light.css" rel="stylesheet" type="text/css" />
	<link href="https://lineoa-appoint.lumpsum.cloud/botpush/boostrap4/dist/assets/css/themes/layout/brand/dark.css" rel="stylesheet" type="text/css" />
	<link href="https://lineoa-appoint.lumpsum.cloud/botpush/boostrap4/dist/assets/css/themes/layout/aside/dark.css" rel="stylesheet" type="text/css" />
	<!--end::Layout Themes-->
</head>
<body>
<?php
...
define('LINE_LOGIN_CALLBACK_URL','lineoa-appoint.lumpsum.cloud/botpush/login_uselib_callback.php');
...
<script src="https://lineoa-appoint.lumpsum.cloud/botpush/boostrap4/dist/assets/plugins/global/plugins.bundle.js"></script>
<script src="https://lineoa-appoint.lumpsum.cloud/botpush/boostrap4/dist/assets/plugins/custom/prismjs/prismjs.bundle.js"></script>
<script src="https://lineoa-appoint.lumpsum.cloud/botpush/boostrap4/dist/assets/js/scripts.bundle.js"></script>
...
<script>
    ...
    $.each(response, function (key, value) {
        if  (value.LineID == "<?= $lineUserData['sub'];?>"){
            ...
            var settings = {
                "url": "https://appointment.eyelism.com/lineoa/api?line="+value.LineID+"&customercode="+value.PatientID+"&customername="+value.LIFF_CustomerName+"&buydate="+value.Display_Buy_Date+"&Frame="+value.LIFF_Frame+"&Lens="+value.LIFF_Lens+"&Final_RE="+value.Final_RE+"&Final_LE="+value.Final_LE,
                "method": "POST",
                "timeout": 0,
                "processData": false,
