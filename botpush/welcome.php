...
<head>
    ...
    <link rel="shortcut icon" href="botpush/theme/dist/assets/media/logos/favicon.ico" />
    ...
    <link href="botpush/theme/dist/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
    <!--end::Vendor Stylesheets-->
    <!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
    <link href="botpush/theme/dist/assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
    <link href="botpush/theme/dist/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
                ...
                <div class="card mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-center flex-column py-5">
                            ...
                            <!--end::User Info-->
                            <!--begin::Badge-->
                            <a href="botpush/logout.php"><div class="btn btn-primary d-inline mb-3">Logout</div></a>
                            <!--begin::Badge-->
                        </div>
                        <!--end::Card body-->
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-xl-9 mb-8 fv-row">
                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                    <span class="required">ผลิดภัณฑ์</span>
                                ...
                                <div class="border rounded">
                                    <select id="kt_docs_select2_rich_content" class="form-select form-select-transparent" name="package" data-placeholder="เลือกผลิดภัณฑ์">
                                       <option></option>
                                        <?php
                                            include('connect.php');
                                            $sqlPackage = "select * from package where compcode = 'demo'" or die("Error:" . mysqli_error($conn));
                                            $resultPackage = mysqli_query($conn,$sqlPackage);
                                            while (($rowPackage = mysqli_fetch_assoc($resultPackage))){?>
                                              <option value="<?=$rowPackage['pcode'];?>" data-bs-toggle="modal" data-bs-target="#selectPackage<?=$rowPackage['pcode'];?>"  data-kt-rich-content-icon="https://bookok.lumpsum.cloud/profile/<?=$rowPackage['image'];?>"><?=$rowPackage['pname'];?></option>
                ...
                <div class="modal-content" style="min-height: 590px;">
                    <div class="modal-header py-5">
                        <div class="d-flex align-items-center">
                            <img src="https://bookok.lumpsum.cloud/profile/<?=$rowPackage['image'];?>" class="rounded-circle w-40px h-40px me-3" alt=""/>
                    ...
                    <div class="modal-body">
                        <?php 
                            $sqlfile = "select * from package_file where compcode = 'demo' and package_code = '".$rowPackage['pcode']."'" or die("Error:" . mysqli_error($conn));
                            $resultfile = mysqli_query($conn,$sqlfile);
                            while (($rowfile = mysqli_fetch_assoc($resultfile))){?>
                                <div class="text-center">
                                    <img src="https://bookok.lumpsum.cloud/uploads/<?=$rowfile['package_img'];?>" style="width: 300px; height: auto;"/>
                                 
                                </div>
                                <!-- <div class="table-responsive">
                                   <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-900px"
                                       style="background-image:url('https://bookok.lumpsum.cloud/uploads/<?=$rowfile['package_img'];?>')">
                                   </div>
                                </div> -->
                        <?php } ?>
                    </div>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="table-responsive">
                               ...
                               <!-- <a class="d-block overlay" data-fslightbox="lightbox-basic" href="https://bookok.lumpsum.cloud/profile/<?=$rowfile['image'];?>"> -->
                                   ...
                                   <p>💌 เลื่อนคิวหรือยกเลิกแจ้งก่อน 24 ชั่วโมง</p>
                                   
                                   <p>(ไม่แจ้งล่วงหน้ามีค่าใช้จ่ายนะคะ)</p>
...
<!--begin::Javascript-->
<script>
    var hostUrl = "botpush/theme/dist/assets/";
</script>
<!--begin::Global Javascript Bundle(mandatory for all pages)-->
<script src="botpush/theme/dist/assets/plugins/global/plugins.bundle.js"></script>
<script src="botpush/theme/dist/assets/js/scripts.bundle.js"></script>
<!--end::Global Javascript Bundle-->
<!--begin::Vendors Javascript(used for this page only)-->
<script src="botpush/theme/dist/assets/plugins/custom/datatables/datatables.bundle.js"></script>
<script src="botpush/theme/dist/assets/plugins/custom/fslightbox/fslightbox.bundle.js"></script>
 ...
 document.getElementById("kt_button_1").disabled = true;
    ...
    $("#kt_button_1").on('click',function(){
         ...
         if(!fullname){
             ...
             $.ajax({
                url: "https://lineoa-appoint.lumpsum.cloud/botpush/payment_success_post.php",
                type: "POST",
                data: {
                    "userid": userid,
                ...
                success: function(result) {
                    ...
                    Swal.fire(
                     ...
                     setInterval(function() {
                        window.location.href = `botpush/welcome.php`;
                    },1000);
                }
             });
         }
    ...
    //         },
    //         "data": {
    //             "cancel_url": "botpush/welcome.php",
    //             "success_url": "botpush/payment_success.php?userid=" + userid + "&startbook=" + encodeURIComponent(bookingdate) + "&timebook=" + encodeURIComponent(bookingtime) + "&name=" + encodeURIComponent(linename) +"&location="+ encodeURIComponent(location) +"&mobile="+mobile + "&amount="+ amount + "&email="+ email + "&fullname="+ encodeURIComponent(fullname),
    ...
    //             // $.ajax({
    //             // url: 'botpush/insert_appointment.php',
    //             // type: 'POST',
    ...
    $("#loadtime").load('botpush/loadtime.php?vardate='+date);
    console.log(date);
